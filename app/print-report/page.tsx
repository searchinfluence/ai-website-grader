...
function PrintReportContent() {
  ...
  return (
    <main className="print-root" style={{ padding: '24px', fontFamily: 'Arial, sans-serif', color: '#111' }}>
      ...
      <section className="print-section print-page-break">
        <h2 style={{ margin: '0 0 10px', fontSize: '1.25rem' }}>Detailed Factor Findings</h2>
