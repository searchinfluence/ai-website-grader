...
- `/components/` -- URLAnalyzer (main form), ScoreReport (results), modals, export buttons

### Data Flow

- **Leads:** Email gate on exports (PDF/Markdown/share) -> Supabase `leads` table + HubSpot CRM
